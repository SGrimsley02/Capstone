...
class VolumeView extends WatchUi.View {
    ...
    private const GRAY_DARK  = 0x333333;
    ...
    function onLayout(dc as Dc) as Void {
        setLayout(Rez.Layouts.VolumeLayout(dc));
    }
    ...
    function onUpdate(dc as Dc) as Void {
        ...
        _drawIconCentered(dc, _upArrow, cx, arrowUpY, TEAL_LITE);
        ...
        _drawIconCentered(dc, _downArrow, cx, arrowDnY, TEAL_LITE);
